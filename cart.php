   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="cart.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Ürünü sepetten silmek istediğine emin misin?');">Sil</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="cart.php?delete_all" onclick="return confirm('delete all from cart?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Hepsini Sil</a></td>
      </tr>
   </tbody>
   </table>
